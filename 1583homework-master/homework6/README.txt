This is the object-oriented dungeon exploration program with combat for Homework 6, by Evan Gary.
...
At the beginning of the game, the player can create a hero. Enter the numbers as instructed. To play in easy mode, enter 32. 
In combat, the hero attacks first. Follow the instructions given. For the Run Away command, there is a 50% chance of success.