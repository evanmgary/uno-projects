/** Dungeon class for object-oriented dungeon exploration program for Homework 5
 *
 * @author	Evan Gary
 * @version	10/26/16
*/
...
public class Dungeon {
	...
	//Constructor
	public Dungeon() {
		entrance = new Room(0, "entrance");
		foyer = new Room(0, "foyer");
		grandHall = new Room(3, "grand hall");
		westCorridor = new Room(0, "west corridor");
		parlor = new Room(1, "parlor");
		diningArea = new Room(0, "dining area");
		kitchen = new Room(2, "kitchen");
		upperHall = new Room(0, "upper hall");
		study = new Room(0, "study");
		tower = new Room(0, "castle tower");
		...
		tower.setDescription("You see the dark wizard that is the master of the castle. He does not attack you. You know you cannot defeat him right now so you run away.");
	}//end constructor
