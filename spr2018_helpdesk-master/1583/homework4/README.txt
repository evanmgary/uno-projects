This is the dungeon exploration program for Homework 4, by Evan Gary.
To compile the program, use a terminal and navigate to the proper directory, then enter
	javac ExploreDungeon.java
...
Any time the player can move or examine, the player can also immediately quit the game.